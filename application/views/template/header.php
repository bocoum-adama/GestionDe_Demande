...
<html>
    <head>
        ...
        <meta content="Plateforme de gestion voitures et rapidos" name="description" />
        <meta content="SIMEN" name="author" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />

        <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/images/SENO_128.png">
