...
<div class="left side-menu">
    <div class="sidebar-inner slimscrollleft">
        <div class="user-details">
            <div class="pull-left">
                <img src="<?= $this->session->photo ?>" alt="" class="thumb-md img-circle" />
            </div>
            <div class="user-info">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php  //echo site_url() 
                                        ?>se_deconnecter"><i class="md md-settings-power"></i> Logout</a></li>
                    </ul>
                </div>
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo base_url(); ?>dashboard" class="waves-effect"><i
                            class="fa fa-tachometer"></i><span> Tableau de bord </span></a>
                </li>
                <?php endif; ?>
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="fa fa-handshake-o"></i><span> Partenaire </span><span
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="fa fa-folder-open"></i><span> Demande </span><span
                            class="pull-right"><i class="md md-add"></i></span></a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="fa fa-institution"></i><span> Structure </span><span
                            class="pull-right"><i class="md md-add"></i></span></a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?php echo base_url(); ?>sys/C_sys_menu" class="menu" id="menu_sys_menu">Menus</a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li><a href="<?php echo base_url(); ?>sys/C_sys_menu/list_sous_menu" class="menu"
                                id="menu_list_sous_menu">Liste Sous Menus</a></li>
                        <?php endif; ?>
                ...
                <?php if (isset($menu_roles['eleve'])) : ?>
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="md md-security"></i><span> Eleve </span><span
                            class="pull-right"><i class="md md-add"></i></span></a>
                    <ul class="list-unstyled">

                        <?php if (isset($smenu_roles['listeeleve']['d_read'])) : ?>
                        <li><a href="<?php echo base_url(); ?>eleve/C_eleve" class="menu"
                                id="menu_liste_eleve">ListEleve</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                <li>
                    <a href="<?php echo base_url(); ?>se_deconnecter" class="waves-effect"><i
                            class="ion-power"></i><span> Déconnexion </span></a>
                </li>
